...
/**
 * VKM Cookie Banner - Basic Usage Example
 *
...
<head>
	...
	<title>Basic Usage - VKM Cookie Banner</title>
	<?= $banner->renderCss() ?>
	<style>
		body {
...
<body>
	...
	<p>This page demonstrates the most basic usage of VKM Cookie Banner.</p>
	...
	<script>
		...
		function updateStatus() {
			...
			if (window.vkmCookieBanner) {
				const hasConsent = window.vkmCookieBanner.hasConsent();
				const accepted = window.vkmCookieBanner.getAcceptedCategories();
